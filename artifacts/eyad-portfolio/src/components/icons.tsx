...
export function BriefcaseIcon({ className = "h-[18px] w-[18px]" }: IconProps) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
...
export function ProcessIcon({ className = "h-[18px] w-[18px]" }: IconProps) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
...
export function BookIcon({ className = "h-[18px] w-[18px]" }: IconProps) {
  return (
    <svg
      aria-hidden="true"
      viewBox="0 0 24 24"
